...
<body>
    ...
    <div class="modal-overlay" id="authModal">
        <div class="modal-container" style="max-width:440px;">
            ...
            <div class="modal-body" style="padding:1.5rem;">
                ...
                <!-- Official Google OAuth 2.0 Sign-In Widget -->
                <div id="g_id_onload"
                ...
                <button class="btn btn-outline" id="loginGoogleBtn" style="width:100%; margin-top:0.6rem; padding:0.65rem; display:flex; align-items:center; justify-content:center; gap:8px;">
    ...
    <script src="js/converter.js?v=2.6.0"></script>
